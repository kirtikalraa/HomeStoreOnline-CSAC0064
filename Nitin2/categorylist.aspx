<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categorylist.aspx.cs" Inherits="Nitin2.categorylist" %>
    ...
    <input type="checkbox" id="show-menu" role="button"/>
        ...
        <li>
            ...
            <ul class="hidden">
              ...
              <asp:Button ID="Button1" runat="server" CssClass="auto-style1" Text="Add Category" Width="230px" PostBackUrl="~/addd.aspx" />
              </p>
          <p style="font-size: xx-large; font-family: 'Century Schoolbook'; font-weight: bolder">
              CATEGORY LIST</p>
    <p style="font-size: xx-large; font-family: 'Century Schoolbook'; font-weight: bolder">
        ...
        <br />
          <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CategoryID" DataSourceID="SqlDataSource1" Width="1336px">
              <Columns>
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [CategoryList]"></asp:SqlDataSource>
</form>
    </body>
    </html>
